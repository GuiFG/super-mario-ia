...
actions_list = [130,128,131,384, 66]
# corre para direita = 130
# anda para a direita = 128
# pula e corre para a direita = 131
# pula girando para a direita = 384
# anda para a esquerda = 66 
